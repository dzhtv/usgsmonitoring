...
public class Config {
    public static final String BASE_URL = "http://earthquake.usgs.gov/fdsnws/event/1/";
    public static final String WEATHER_URL = "http://api.openweathermap.org/data/2.5/";
    public static final String NASA_URL_MARS_PHOTOS = "https://api.nasa.gov/mars-photos/api/v1/";
